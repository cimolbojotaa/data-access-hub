...
dashboards = [
    ...
    (
        "Daily Kesesuaian Data SO (for Crew)",
        "App yang bisa digunakan Crew untuk mengecek kesesuaian antara data SO dan data DRetail",
        "https://so-crk.streamlit.app/"
    )
]
    ...
    with cols[i % 4]:
        st.markdown(
            ...
            <div class="dashboard-card">
                <div class="dashboard-title">{d[0]}</div>
                <div class="dashboard-desc">{d[1]}</div>
...
for i, f in enumerate(forms):
    with cols[i % 4]:
        st.markdown(
            f"""
            <div class="dashboard-card">
                <div class="dashboard-title">{f[0]}</div>
                <div class="dashboard-desc">{f[1]}</div>
                <a href="{f[2]}" target="_blank">
...
for i, b in enumerate(bases):
    with cols[i % 4]:
        st.markdown(
            f"""
            <div class="dashboard-card">
                <div class="dashboard-title">{b[0]}</div>
                <div class="dashboard-desc">{b[1]}</div>
                <a href="{b[2]}" target="_blank">
